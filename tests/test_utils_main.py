...
from src.project_1.utils import (get_cost_of_card, get_currency_rates,
                                 get_data_time, get_table_period,
...
def mock_card_and_transaction_data():
    ...
    data = {
        ...
        "Номер карты": ["**1234", "**5678", "**1234", "**5678", "**9012", "**1234", "**5678", "**9012", "**1234"],
        "Категория": [
            "Еда",
            "Транспорт",
            "Развлечения",
